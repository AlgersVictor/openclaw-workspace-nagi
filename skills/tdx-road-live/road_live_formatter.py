...
def format_congestion_summary(city_label: str, item_count: int) -> str:
    return f"{city_label} 壅塞等級查詢完成，共整理 {item_count} 筆路段壅塞資料。"


def format_cctv_summary(city_label: str, item_count: int) -> str:
    return f"{city_label} 監視器查詢完成，共整理 {item_count} 處 CCTV 資料。"
